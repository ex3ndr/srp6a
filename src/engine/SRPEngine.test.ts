...
describe('SRPEngine', () => {
    ...
    it('should compute multiplier', () => {
        expect(engine.k.toHex().toUpperCase()).toBe('7556AA045AEF2CDD07ABAF0F665C3E818913186F');
    });
    ...
    it('should compute server public key', () => {
        ...
        const v = BigInt.fromBuffer(bufferFromSpecHex(
            '7E273DE8 696FFC4F 4E337D05 B4B375BE B0DDE156 9E8FA00A 9886D812' +
            '9BADA1F1 822223CA 1A605B53 0E379BA4 729FDC59 F105B478 7E5186F5' +
            'C671085A 1447B52A 48CF1970 B4FB6F84 00BBF4CE BFBB1681 52E08AB5' +
            'EA53D15C 1AFF87B2 B9DA6E04 E058AD51 CC72BFC9 033B564E 26480D78' +
            'E955A5E2 9E7AB245 DB2BE315 E2099AFB'));
        const b = BigInt.fromBuffer(bufferFromSpecHex(
    ...
    it('should compute server private key', () => {
        ...
        const a = BigInt.fromBuffer(bufferFromSpecHex(
    ...
    it('should compute client session key', () => {
        ...
        const x = BigInt.fromBuffer(bufferFromSpecHex(
            '94B7555AABE9127CC58CCF4993DB6CF84D16C124'
        ));
        const u = BigInt.fromBuffer(bufferFromSpecHex(
            'CE38B959 3487DA98 554ED47D 70A7AE5F 462EF019'
        ));
    ...
    it('should compute server strong session key', () => {
        ...
        const S = BigInt.fromBuffer(bufferFromSpecHex('B0DC82BA BCF30674 AE450C02 87745E79 90A3381F 63B387AA F271A10D' +
            '233861E3 59B48220 F7C4693C 9AE12B0A 6F67809F 0876E2D0 13800D6C' +
            '41BB59B6 D5979B5C 00A172B4 A2A5903A 0BDCAF8A 709585EB 2AFAFA8F' +
            '3499B200 210DCC1F 10EB3394 3CD67FC8 8A2F39A4 BE5BEC4E C0A3212D' +
            'C346D7E4 74B29EDE 8A469FFE CA686E5A'));
